...
namespace Vouchee.Business.Services.Extensions.Filebase
{
    public class FileUploadService : IFileUploadService
    {
        ...
        public async Task<string> UploadPromotionImageToFirebase(IFormFile file, string uid)
        {
            try
            {
                ...
                var task = new FirebaseStorage(_firebaseSettings.Bucket,
                                                    ...
                                                    .Child(StoragePathEnum.PROMOTION.ToString())
                                                    .Child(file.FileName)
        ...
        public async Task<string> UploadVoucherImageToFirebase(IFormFile file, string uid)
        {
            try
            {
                var tokenDescriptor = new Dictionary<string, object>()
