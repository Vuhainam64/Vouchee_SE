...
namespace Vouchee.Data.Migrations
{
    ...
    [Migration("20241012130940_Check")]
    partial class Check
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Vouchee.Data.Models.Entities.Voucher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 10, 16, 20, 9, 40, 335, DateTimeKind.Local).AddTicks(7816),
                            PercentShow = 10m,
                            Price = 100000m,
                            Quantity = 100,
                            StarDate = new DateTime(2024, 10, 12, 20, 9, 40, 335, DateTimeKind.Local).AddTicks(7806),
                            Status = "ACTIVE",
                        ...
                        new
                        {
                            ...
                            CreateBy = new Guid("b4583f49-baba-4916-8e2b-2d44c3412733"),
                            EndDate = new DateTime(2024, 10, 16, 20, 9, 40, 335, DateTimeKind.Local).AddTicks(7830),
                            PercentShow = 10m,
                            Price = 100000m,
                            Quantity = 100,
                            StarDate = new DateTime(2024, 10, 12, 20, 9, 40, 335, DateTimeKind.Local).AddTicks(7830),
                            Status = "ACTIVE",
                            SupplierId = new Guid("a053e9fc-7962-4eaa-8377-91c56c85cda6"),
                            Title = "Voucher sale",
                            VoucherTypeId = new Guid("3e676315-1a28-4a0b-beb5-eaa5336a108d")
