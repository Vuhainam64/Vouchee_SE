...
namespace Vouchee.Data.Migrations
{
    ...
    [Migration("20241013134440_ManyToManyVoucherCategory")]
    partial class ManyToManyVoucherCategory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Vouchee.Data.Models.Entities.Voucher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 10, 17, 20, 44, 40, 344, DateTimeKind.Local).AddTicks(962),
                            OriginalPrice = 100000m,
                            PercentShow = 10m,
                            Quantity = 100,
                            SalePrice = 0m,
                            StartDate = new DateTime(2024, 10, 13, 20, 44, 40, 344, DateTimeKind.Local).AddTicks(954),
                            Status = "ACTIVE",
                        ...
                        new
                        {
                            ...
                            CreateBy = new Guid("b4583f49-baba-4916-8e2b-2d44c3412733"),
                            EndDate = new DateTime(2024, 10, 17, 20, 44, 40, 344, DateTimeKind.Local).AddTicks(978),
                            OriginalPrice = 100000m,
                            PercentShow = 10m,
                            Quantity = 100,
                            SalePrice = 0m,
                            StartDate = new DateTime(2024, 10, 13, 20, 44, 40, 344, DateTimeKind.Local).AddTicks(977),
                            Status = "ACTIVE",
                            SupplierId = new Guid("a053e9fc-7962-4eaa-8377-91c56c85cda6"),
                            Title = "Voucher sale",
                            VoucherTypeId = new Guid("3e676315-1a28-4a0b-beb5-eaa5336a108d")
