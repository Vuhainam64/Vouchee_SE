...
namespace Vouchee.Data.Migrations
{
    ...
    [Migration("20241013115006_AllowNullLonLat")]
    partial class AllowNullLonLat
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Vouchee.Data.Models.Entities.Voucher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 10, 17, 18, 50, 4, 611, DateTimeKind.Local).AddTicks(9849),
                            PercentShow = 10m,
                            Price = 100000m,
                            Quantity = 100,
                            StartDate = new DateTime(2024, 10, 13, 18, 50, 4, 611, DateTimeKind.Local).AddTicks(9840),
                            Status = "ACTIVE",
                        ...
                        new
                        {
                            ...
                            CreateBy = new Guid("b4583f49-baba-4916-8e2b-2d44c3412733"),
                            EndDate = new DateTime(2024, 10, 17, 18, 50, 4, 611, DateTimeKind.Local).AddTicks(9865),
                            PercentShow = 10m,
                            Price = 100000m,
                            Quantity = 100,
                            StartDate = new DateTime(2024, 10, 13, 18, 50, 4, 611, DateTimeKind.Local).AddTicks(9864),
                            Status = "ACTIVE",
                            SupplierId = new Guid("a053e9fc-7962-4eaa-8377-91c56c85cda6"),
                            Title = "Voucher sale",
                            VoucherTypeId = new Guid("3e676315-1a28-4a0b-beb5-eaa5336a108d")
