            ...
            modelBuilder.Entity("Vouchee.Data.Models.Entities.Voucher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 10, 18, 18, 37, 23, 281, DateTimeKind.Local).AddTicks(3789),
                            OriginalPrice = 100000m,
                            PercentShow = 10m,
                            Quantity = 100,
                            StartDate = new DateTime(2024, 10, 14, 18, 37, 23, 281, DateTimeKind.Local).AddTicks(3775),
                            Status = "ACTIVE",
                        ...
                        new
                        {
                            ...
                            CreateBy = new Guid("b4583f49-baba-4916-8e2b-2d44c3412733"),
                            EndDate = new DateTime(2024, 10, 18, 18, 37, 23, 281, DateTimeKind.Local).AddTicks(3811),
                            OriginalPrice = 100000m,
                            PercentShow = 10m,
                            Quantity = 100,
                            StartDate = new DateTime(2024, 10, 14, 18, 37, 23, 281, DateTimeKind.Local).AddTicks(3810),
                            Status = "ACTIVE",
                            SupplierId = new Guid("a053e9fc-7962-4eaa-8377-91c56c85cda6"),
                            Title = "Voucher sale",
                            VoucherTypeId = new Guid("3e676315-1a28-4a0b-beb5-eaa5336a108d")
