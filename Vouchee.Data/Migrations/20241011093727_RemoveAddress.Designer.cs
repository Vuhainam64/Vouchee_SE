...
namespace Vouchee.Data.Migrations
{
    ...
    [Migration("20241011093727_RemoveAddress")]
            ...
            modelBuilder.Entity("Vouchee.Data.Models.Entities.Voucher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 10, 15, 16, 37, 26, 792, DateTimeKind.Local).AddTicks(2391),
                            Name = "Voucher sale",
                            PercentShow = 10m,
                            Price = 100000m,
                            Quantity = 100,
                            StarDate = new DateTime(2024, 10, 11, 16, 37, 26, 792, DateTimeKind.Local).AddTicks(2381),
                            Status = "ACTIVE",
                        ...
                        new
                        {
                            ...
                            CreateBy = new Guid("b4583f49-baba-4916-8e2b-2d44c3412733"),
                            EndDate = new DateTime(2024, 10, 15, 16, 37, 26, 792, DateTimeKind.Local).AddTicks(2406),
                            Name = "Voucher sale",
                            PercentShow = 10m,
                            Price = 100000m,
                            Quantity = 100,
                            StarDate = new DateTime(2024, 10, 11, 16, 37, 26, 792, DateTimeKind.Local).AddTicks(2405),
                            Status = "ACTIVE",
                            SupplierId = new Guid("a053e9fc-7962-4eaa-8377-91c56c85cda6"),
                            VoucherTypeId = new Guid("3e676315-1a28-4a0b-beb5-eaa5336a108d")
                        });
